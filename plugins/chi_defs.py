...
'submit_btn': 'Create My Account',
    ...
    if not sec: return
    req_sec = find_between(sec, '', '_secret')
    return sec,req_sec
...
'payment_method_data[guid]': '012210d2-9290-433e-bacc-f0601c21c448f76a3a',
'payment_method_data[muid]': '4cb69869-b6a8-437a-8843-5ab5075fabfcfa69fe',
'payment_method_data[sid]': 'd1835d01-a787-48b1-a341-5ae0e73d9f48d4e0eb',
